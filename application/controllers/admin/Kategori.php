...
class Kategori extends CI_Controller {
    ...
    public function simpan(){
        ...
        $this->session->set_flashdata('alert','
        <div class="alert alert-success alert-dismissible fade show" role="alert">
             <i class="fa fa-exclamation-circle me-2"></i>Berhasil menambahkan kategori, yeayyy
        </div>
        ');
        redirect('admin/kategori');
    }
    public function delete_data($id){
        ...
        $this->session->set_flashdata('alert','
        <div class="alert alert-success alert-dismissible fade show" role="alert">
             <i class="fa fa-exclamation-circle me-2"></i>Berhasil Menghapus Kategori, yeayyy
        </div>
        ');
        redirect('admin/kategori');
    }
    public function update(){
        ...
        $this->session->set_flashdata('alert','
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <i class="fa fa-exclamation-circle me-2"></i>Berhasil Memperbarui Kategori, yeayyy
        </div>
        ');
        redirect('admin/kategori');
    }
