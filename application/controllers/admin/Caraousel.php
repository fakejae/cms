...
class Caraousel extends CI_Controller {
    ...
    public function simpan(){
        ...
        if($_FILES['foto']['size'] >= 500 * 1024){
            ...
            <div class="alert alert-success alert-dismissible fade show" role="alert">
             ...
             Ukuran foto terlalu besar, upload ulang foto dengan ukuran yang kurang dari 500mb
            </div>
            ');
        ...
        $this->session->set_flashdata('alert','
        <div class="alert alert-success alert-dismissible fade show" role="alert">
             <i class="fa fa-exclamation-circle me-2"></i>Berhasil menambahkan caraousel, yeayyy
        </div>
        ');
        redirect('admin/caraousel');
    }
    ...
    public function delete_data($id){
        ...
        $this->session->set_flashdata('alert','
        <div class="alert alert-success alert-dismissible fade show" role="alert">
             <i class="fa fa-exclamation-circle me-2"></i>Berhasil Menghapus Caraousel, yeayyy
        </div>
        ');
        redirect('admin/caraousel');
    }
